      ...
      <div class="col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <table>
                	<tr>
                		<td><a href="{{ route('Parentesco.edit', $parentesco-> id_parentesco)}}" class="btn btn-primary">Editar</a>
                		</td>
                		<td><form method="POST" action="{{ route('Parentesco.destroy', $parentesco -> id_parentesco)}}" class="delete" id="{{ $parentesco -> id_parentesco }}">
								{!! method_field('DELETE') !!}
							 	{!! csrf_field() !!}
