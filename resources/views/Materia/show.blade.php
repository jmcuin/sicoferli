      ...
      <div class="col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <table>
                	<tr>
                		<td><a href="{{ route('Materia.edit', $materia-> id_materia)}}" class="btn btn-primary">Editar</a>
                		</td>
                		<td><form method="POST" action="{{ route('Materia.destroy', $materia -> id_materia)}}" class="delete" id="{{ $materia -> id_materia }}">
								{!! method_field('DELETE') !!}
							 	{!! csrf_field() !!}
