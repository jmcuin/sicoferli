      ...
      <div class="col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <table>
                	<tr>
                		<td><a href="{{ route('PrepAcademica.edit', $prepacademica-> id_prep_academica)}}" class="btn btn-primary">Editar</a>
                		</td>
                		<td><form method="POST" action="{{ route('PrepAcademica.destroy', $prepacademica -> id_prep_academica)}}" class="delete" id="{{ $prepacademica -> id_prep_academica }}">
								{!! method_field('DELETE') !!}
							 	{!! csrf_field() !!}
